 ...
 * 
 */
public class DeEscaladaMaximaPendiente extends Algoritmo
{            
    public DeEscaladaMaximaPendiente(Tablero t)
    {
        this.Raiz = new Nodo(t);
    }
    
    public DeEscaladaMaximaPendiente(Nodo t)
    {
        this.Raiz = t;
    }
    ...
    {     
        ...
        {
            Nodo nuevo = explorar(posiblesMovimientos.get(0));
            return nuevo;
        }
        else
        {
            ...
            Nodo nuevo = explorar(posiblesMovimientos.get(indice));
            return nuevo;
        }                                                         
    }
